...
app.post('/', async function(req, res){
    ...
    res.render('index', {city: cityName, country: findCountry(countryCode), weather: temperature, des: description, ic: pickIcon(iconCode), ws: windSpeed, wd: findWindDirection(windDirection), p: pressure, h: humidity, photos: photoURL, error: null});
    } catch(err){
      res.render('index', {weather: null, error: 'An error has occured during one of the API calls'})
    }
});
